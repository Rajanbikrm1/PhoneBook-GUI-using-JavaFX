 ...
 * @author Rajan
 */
public class SearchByNotesTableController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        name.setText(PhoneBookConstant.SEARCH_BY_NOTES_KEYWORD);
        ...
        for (Entry entry : PhoneBookGui.entryList) {
            if (entry != null) {
                if (entry.notes.toLowerCase().contains(PhoneBookConstant.SEARCH_BY_NOTES_KEYWORD.toLowerCase())) {
